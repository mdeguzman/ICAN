...
/**
 * These are the HL7 field location mappings for PACS Z segments
 * For PACS, all mappings for standard HL7 segments(and HL7 sub field mappings i.e CE, CX, XPN ....)
 * are held in the HL7_23 (or HL7_24) class files.
 */

public class PACS_23 {

    public static String ZPR_1_Set_Id  ="ZPR_1";
    public static String ZPR_2_Tissue_Code  ="ZPR_2";
//
    /**
     *ZFT Financial segment decodes.
     * ZFT is not really a PACS segment but is sent as part of a custom written
...
//public static String ZEI_15_Contact_Title  ="ZEI_16";
    ...
    /**
     * Creates a new instance of PACS_23
     */
    public PACS_23() {
    }
