 ...
 * @author fillinghamr
 */
public class OZESCRIBEFILEDROPProcessFromUFD extends ProcessSegmentsFromUFD {

    public String mEnvironment = "";
    /**
     * Creates a new instance of SQLProcessFromUFD
     */
    public OZESCRIBEFILEDROPProcessFromUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
        Logger.getLogger(OZESCRIBEFILEDROPProcessFromUFD.class.getName()).log(Level.SEVERE, null,"Super In Message   " + mHL7Message);
        mVersion = "A";
...
//        } else
        ...
        if ((super.hasValue(HL7_23.MSH_9_1_message_type,"ORU") &&
                (super.hasValue(HL7_23.MSH_9_2_trigger_event, "R01") || super.hasValue(HL7_23.MSH_9_2_trigger_event, "R03") || super.hasValue(HL7_23.MSH_9_2_trigger_event, "W01")))
                ) {
              //aOutMess.setSegment(processMSHFromUFD("OZESCRIBE").getSegment());
