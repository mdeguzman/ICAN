...
package com.dataagility.ICAN.BHLibOZESCRIBE;
 ...
 * @author fillinghamr
 */
public class OZESCRIBEProcessFromUFD extends ProcessSegmentsFromUFD {

    public String mEnvironment = "";
    /**
     * Creates a new instance of SQLProcessFromUFD
     */
    public OZESCRIBEProcessFromUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
        Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null,"Super In Message   " + mHL7Message);
        mVersion = "A";
    ...
    public String[] processMessage() throws ICANException {
        ...
        HL7Message aOutMess = new HL7Message(mHL7Message);  //k.NULL
       ...
       //aOutMess.setSegment(processMSHFromUFD("OZESCRIBE").getSegment());
            //aOutMess.setSegment(aMSHSegment.getSegment());

            //Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null,"Super In Message Again   " + aOutMess.getMessage());
...
//        } else
        ...
        if ((super.hasValue(HL7_23.MSH_9_1_message_type,"ADT") &&
                !aPV1SegmentTemp.hasValue(HL7_23.PV1_2_patient_class,"PO") &&
                (super.hasValue(HL7_23.MSH_9_2_trigger_event, "A01") || super.hasValue(HL7_23.MSH_9_2_trigger_event, "A08") || super.hasValue(HL7_23.MSH_9_2_trigger_event, "A04"))) ||
                super.hasValue(HL7_23.MSH_9_1_message_type,"SIU")) {
            aOutMess.setSegment(processMSHFromUFD("OZESCRIBE").getSegment());
//            Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null, aOutMess.getMessage());
//            aOutMess.append(processEVNFromUFD());
//            Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null, aOutMess.getMessage());
//            aOutMess.append(processPIDFromUFD());
//            Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null, aOutMess.getMessage());
...
//            Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null, aOutMess.getMessage());
//
//            Logger.getLogger(OZESCRIBEProcessFromUFD.class.getName()).log(Level.SEVERE, null,"Super In Message Again   " + mHL7Message);
//            //  ZPD
//            //  ZMR
