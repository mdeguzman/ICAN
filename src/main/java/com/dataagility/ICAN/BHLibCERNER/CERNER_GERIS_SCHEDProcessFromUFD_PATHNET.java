 ...
 * @author sohn
 */
public class CERNER_GERIS_SCHEDProcessFromUFD_PATHNET extends ProcessSegmentsFromUFD {
    ...
    public CERNER_GERIS_SCHEDProcessFromUFD_PATHNET(String pHL7Message, String pEnvironment)  throws ICANException {
        super(pHL7Message);
    ...
    public String[] processMessage() throws ICANException {
        ...
        if (mInHL7Message.isEvent("S12, S14, S15, S26")) {
            ...
            HL7Segment aMSHSegment = processMSHFromUFD("SCH_RIS", "CERNERSCH_CLONE");
