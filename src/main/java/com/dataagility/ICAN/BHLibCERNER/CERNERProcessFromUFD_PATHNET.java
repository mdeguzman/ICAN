 ...
 * @author fillinghamr
 */
public class CERNERProcessFromUFD_PATHNET extends ProcessSegmentsFromUFD {
     ...
     */
    public CERNERProcessFromUFD_PATHNET(String pHL7Message, String pEnvironment)  throws ICANException {
