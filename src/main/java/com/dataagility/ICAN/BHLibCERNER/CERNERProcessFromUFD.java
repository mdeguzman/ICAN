 ...
 * @author fillinghamr
 */
public class CERNERProcessFromUFD extends ProcessSegmentsFromUFD {
     ...
     */
    public CERNERProcessFromUFD(String pHL7Message, String pEnvironment)  throws ICANException {
...
//    }
        ...
        /* changed to resolve issue with the use of the species flag for non-species data as above ^*/
     aZPIOut.set(CERNER_23.ZPI_15_Species, "H");
