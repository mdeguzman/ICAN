 ...
 * @author sohn
 */
public class CERNER_GERISProcessFromUFD extends ProcessSegmentsFromUFD {
     ...
     */
    public CERNER_GERISProcessFromUFD(String pHL7Message, String pEnvironment)  throws ICANException {
        super(pHL7Message);
...
// We are only interested in the 1st instance of the name ....
        ...
        /*
          * By KIRAN BUSI 4th May 2010
          * FromGERIS to CernerATD
          * If Incoming Message's PV1-19 has GE as alpha prefix,
          * copy contents of visit number to PID-18
         */
         aOutPIDSegment = replacePID_18WithPV1_19( mInHL7Message, aOutPIDSegment );
         //System.out.println("PID SEGMENT NEW:" + aOutPID.getSegment() );

        return aOutPIDSegment;
    }

    /* By Kiran Busi
     * Return PID segment with PID-18 replaced with PV1-19
     */
    private HL7Segment replacePID_18WithPV1_19(HL7Message aHL7Message, HL7Segment pidSeg ){

        HL7Segment pidSegment = pidSeg;

        String pid_18 = pidSegment.get( HL7_23.PID_18_account_number );
        //System.out.println("PID-18 in Message Before Copying FIN NBR Val:" + pid_18 );
        //System.out.println("Entire Message PID:" + pidSegment.getSegment() );
        ...
        //System.out.println("PV1 SEGMENT: " + aPV1Segment.getSegment() );
        String pv1_19 = aPV1Segment.get( HL7_23.PV1_19_visit_number );

        //System.out.println("PV1-19:" + pv1_19 );

        //Tokenize by "^" to get only first part of String
        // Ex: GE2222^2222^^ALF ( get GE2222 )
        if( !pv1_19.isEmpty() ){

            StringTokenizer strTkn = new StringTokenizer(pv1_19, "^");
            String firstToken = strTkn.nextToken();
            //System.out.println("First Token " + firstToken );

            /*
            //If has GE as alpha prefix, strip GE from String
            if( firstToken.startsWith( "GE" )){
                firstToken = firstToken.substring(2);
            }*/
            //System.out.println("New Trimmed Str: " + firstToken );
            pv1_19 = firstToken;

        }//fi

        //Copy PV1-19 to PID-18
        pidSegment.set(HL7_23.PID_18_account_number, pv1_19 );
        //Print new PID-18
        //System.out.println("New PID-18: " + pidSegment.get(HL7_23.PID_18_account_number));
        // END Interface Code
        return pidSegment;
    }
...
//            aOutOBRSegment.set(HL7_23.OBR_4_Universal_Service_ID, HL7_23.CE_ID_code, "FILMBAG");
            ...
            //aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, 1);
            //move obr27-1 to obr27-4 gg
            String aQuantity_Timing_4 = "";
            aQuantity_Timing_4 = aInOBRSegment.get(HL7_23.OBR_27_Quantity_Timing, 1);
            aOutOBRSegment.set(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_4_start_date_time, aQuantity_Timing_4);

            // AS 22/01/21015 - changed to copy whole field rather than subfields
//            int aQuantityTimingCount = aInOBRSegment.countRepeatFields(HL7_23.OBR_27_Quantity_Timing);
//            for (int j = 1; j <= aQuantityTimingCount; j++) {
//                //aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_1_quantity, j);
//                aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_4_start_date_time, j);
    ...
    public HL7Group processURLReqDets_FromUFD(HL7Segment pPIDSegment, HL7Segment pMSHSegment) {
        ...
        for (int i = 1; i <= aRequestDetsCount; i++) {
           ...
           // aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, 1);
             ...
             //move obr27-1 to obr27-4 gg
            String aQuantity_Timing_StartDateTime = "";
            aQuantity_Timing_StartDateTime = aInOBRSegment.get(HL7_23.OBR_27_Quantity_Timing, 1);
            aOutOBRSegment.set(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_4_start_date_time, aQuantity_Timing_StartDateTime);
//            int aQuantityTimingCount = aInOBRSegment.countRepeatFields(HL7_23.OBR_27_Quantity_Timing);
//            for (int j = 1; j <= aQuantityTimingCount; j++) {
//                aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_1_quantity, j);
//                aOutOBRSegment.copy(HL7_23.OBR_27_Quantity_Timing, HL7_23.TQ_4_start_date_time, j);
