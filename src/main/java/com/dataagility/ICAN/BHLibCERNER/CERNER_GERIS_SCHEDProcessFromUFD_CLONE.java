 ...
 * @author sohn
 */
public class CERNER_GERIS_SCHEDProcessFromUFD_CLONE extends ProcessSegmentsFromUFD {
    ...
    public CERNER_GERIS_SCHEDProcessFromUFD_CLONE(String pHL7Message, String pEnvironment)  throws ICANException {
        super(pHL7Message);
