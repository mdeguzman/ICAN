...
package com.dataagility.ICAN.BHLibVIDRL;
 ...
 * @author normansoh
 */
public class VIDRLProcessFromUFD extends ProcessSegmentsFromUFD {
     ...
     */
    public VIDRLProcessFromUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
        mVersion = "A";
    ...
    public String[] processMessage() throws ICANException {
        ...
        String aVIDRLMessageArray[] = {k.NULL, k.NULL, k.NULL};
        ...
        if (aProceedFlag == true) {
            ...
            //aOutMess = aInMess;
            aMSHSegment.set(HL7_23.MSH_5_receiving_application, "VIDRL");
            aMSHSegment.set(HL7_23.MSH_6_receiving_facility, "EM");
            aOutMess.setSegment(aMSHSegment.getSegment(), 1);
            aVIDRLMessageArray[0] = aMSHSegment.get(HL7_23.MSH_3_sending_application);
            aVIDRLMessageArray[1] = aMSHSegment.get(HL7_23.MSH_4_sending_facility);
            aVIDRLMessageArray[2] = aOutMess.getMessage();

            return aVIDRLMessageArray;
        }
        return aVIDRLMessageArray;
    }
