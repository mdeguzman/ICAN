...
/**
 * CARDIOProcessFromUFD_old contains the methods required to build a CARDIO message
 * from a UFD HL7 message structureA
 *
 * @author Ray Fillingham and Norman Soh
 */
public class CARDIOProcessFromUFD_old extends ProcessSegmentsFromUFD {
    /**
     * Constant class
     */
    ...
    /**
     * This constructor creates a new instance of CARDIOProcessFromUFD_old passing a HL7 UFD
     * message structure
     *
     * @param pHL7Message HL7 message text string
     * @throws ICANException ICANException
     */
    public CARDIOProcessFromUFD_old(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
