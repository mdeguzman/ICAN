 ...
 *
 */
package com.dataagility.ICAN.BHLibCERNER_PATHNET;

import com.dataagility.ICAN.BHLibCERNER.CERNER_23;
 ...
 */
public class CERNER_PATHNETProcessToUFD extends ProcessSegmentsToUFD {
     ...
     */
    public CERNER_PATHNETProcessToUFD(String pHL7Message) throws ICANException {
        super(pHL7Message);
...
//    }
    ...
    public HL7Group processOrderObservations_ToUFD() {
        HL7Group aOutOrderObservationsGroup = new HL7Group("");
        HL7Group aInOrderObservationsGroup = new HL7Group("");
        int aGroupCount;
        int aCount = 1;
        ...
        for (aCount = 1; aCount <= aGroupCount; aCount++) {
            ...
            aInOrderObservationsGroup = new HL7Group(mInHL7Message.getGroup(aGroupID, aCount));
            int groupSegCount = aInOrderObservationsGroup.countSegments();
            for (int i = 1; i <= groupSegCount; i++) {

                aInSegment = new HL7Segment(aInOrderObservationsGroup.getSegment(i));
                if (aInSegment.getSegmentID().equalsIgnoreCase("OBX")) {
                    if (aInSegment.get(HL7_23.OBX_2_value_type).equalsIgnoreCase("CE")) {
                        String[] value = aInSegment.get(HL7_23.OBX_5_observation_value).split("\\^", -1);
                        aInSegment.set(HL7_23.OBX_5_observation_value, value[0]);
                    }

                }
                aOutOrderObservationsGroup.append(aInSegment);
            }
