...
import com.dataagility.ICAN.BHLibCERNER.*;
 ...
 */
public class CERNERProcessToUFD_MOCK extends ProcessSegmentsToUFD {
    /**
     ...
     */
    public CERNERProcessToUFD_MOCK(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
    ...
    public String processMessage() throws ICANException {
        ...
        if (mInHL7Message.isEvent("O01")) {        // Order processing ... NOTE :- Event is Oh! zero one not zero zero one!.
            ...
            HL7Segment aMSHSegment = processCERNERMSHToUFD();
            HL7Segment aPIDSegment = processPIDToUFD();
            HL7Group aPIDNTEGroup = processCERNERPIDNTEToUFD();
...
//        }
    ...
    public HL7Segment processCERNERMSHToUFD() {
        ...
        if (aPID3AssAuth.equalsIgnoreCase("ALFUR")) {
            aOutMSHSegment.set(HL7_23.MSH_3_sending_application, "CERNER-ALF");
            aOutMSHSegment.set(HL7_23.MSH_4_sending_facility, "ALF");
            aOutMSHSegment.set(HL7_23.MSH_6_receiving_facility, "ALF");
        } else if(aPID3AssAuth.equalsIgnoreCase("SDMHUR")) {
            aOutMSHSegment.set(HL7_23.MSH_3_sending_application, "CERNER-SDMH");
            aOutMSHSegment.set(HL7_23.MSH_4_sending_facility, "SDMH");
            aOutMSHSegment.set(HL7_23.MSH_6_receiving_facility, "SDMH");
        } else if(aPID3AssAuth.equalsIgnoreCase("CGMCUR")) {
            aOutMSHSegment.set(HL7_23.MSH_3_sending_application, "CERNER-CGMC");
     ...
     * @return PIDNTE group
     */
    public HL7Group processCERNERPIDNTEToUFD() {
