...
package com.dataagility.ICAN.BHLibOPAS;

import com.dataagility.ICAN.BHLibClasses.*;

/**
 * OPASProcessFromUFD contains the methods required to build a OPAS message
 * from a UFD HL7 message structure
 * @author Ray Fillingham and Norman Soh
 */
public class OPASProcessFromUFD extends ProcessSegmentsFromUFD {
    /**
     * Constant class
     */
    ...
    //--------------------------------------------------------------------------
    /**
     * This constructor creates a new instance of OPASProcessFromUFD passing a HL7 UFD
     * message structure
     * @param pHL7Message HL7 message text string
     * @throws BHLibClasses.ICANException ICANException
     */
    public OPASProcessFromUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
    ...
    public String[] processMessage() throws ICANException {
        ...
        mVersion = "B";
        String aOPASMessageArray[] = {k.NULL, k.NULL, k.NULL};
        ...
        if (mInHL7Message.isEvent("A01, A02, A03, A04, A08, A11, A12, A13, A21, A22, A28, A31") &&
            ...
            HL7Segment aMSHSegment = processMSHFromUFD("OPAS");
            ...
            aMSHSegment = processOPAS_MSH(aMSHSegment);
            aPIDSegment = processOPAS_PID(aPIDSegment);
            //aNK1Group = processOPAS_NK1(aNK1Group);
            aPV1Segment = processOPAS_PV1(aPV1Segment);
            aPV2Segment = processOPAS_PV2(aPV2Segment);
            aZPDSegment = processOPAS_ZPD(aZPDSegment, aPV1Segment);
            aZMRSegment = processOPAS_ZMR(aZMRSegment);

            System.out.println("++++ Processing ZBX Segments for OPAS");
            aZBXGroup = processOPAS_ZBX(mInHL7Message);
            ...
            aOPASMessageArray[0] = aMSHSegment.get(HL7_23.MSH_3_sending_application);
            aOPASMessageArray[1] = aMSHSegment.get(HL7_23.MSH_4_sending_facility);
            aOPASMessageArray[2] = aOutHL7Message.getMessage();
        }
        return aOPASMessageArray;
    }
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for MSH segment
     * @param pMSHSegment MSH segment class object
     * @return MSH segment class object
     * @throws BHLibClasses.ICANException ICANException
     */
    public HL7Segment processOPAS_MSH(HL7Segment pMSHSegment) throws ICANException {
    ...
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for PID segment
     * @param pPIDSegment PID segment
     * @throws BHLibClasses.ICANException ICANException
     * @return PID segment
     */
    public HL7Segment processOPAS_PID(HL7Segment pPIDSegment) throws ICANException {
    ...
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for NK1 group
     * @param pNK1Group NK1 group
     * @throws BHLibClasses.ICANException ICANException
     * @return NK1 group
     */
    public HL7Group processOPAS_NK1(HL7Group pNK1Group) throws ICANException {
    ...
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for PV1 segment
     * @param pPV1Segment PV1 segment
     * @throws BHLibClasses.ICANException ICANException
     * @return PV1 segment
     */
    public HL7Segment processOPAS_PV1(HL7Segment pPV1Segment) throws ICANException {
    ...
    public HL7Segment processOPAS_PV2(HL7Segment pPV2Segment) throws ICANException {
    ...
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for ZPD segment
     * @param pZPDSegment ZPD segment
     * @param pPV1Segment PV1 segment
     * @throws BHLibClasses.ICANException ICANException
     * @return ZPD segment
     */
    public HL7Segment processOPAS_ZPD(HL7Segment pZPDSegment, HL7Segment pPV1Segment) throws ICANException {
        ...
        aOutZPDSegment.set(OPAS_23.ZPD_2_patient_team, aHospitalService);
        aOutZPDSegment.set(OPAS_23.ZPD_1, aClaim_no);
        return aOutZPDSegment;

    }
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for ZMR segment
     * @param pZMRSegment ZMR segment
     * @throws BHLibClasses.ICANException ICANException
     * @return ZMR segment
     */
    public HL7Segment processOPAS_ZMR(HL7Segment pZMRSegment) throws ICANException {
...
//                aTime = "\"\"";
            ...
            pZMRSegment = new HL7Segment(OPAS_23.ZMR);
            pZMRSegment.set(OPAS_23.ZMR_1_Last_Movement_Date, aDate);
            pZMRSegment.set(OPAS_23.ZMR_2_Last_Movement_Time, aTime);
            pZMRSegment.set(OPAS_23.ZMR_3_Volume_Number, aVolumeNumber);
            pZMRSegment.set(OPAS_23.ZMR_4_Location, aLocation);
            pZMRSegment.set(OPAS_23.ZMR_5_Received_By, aReceivedBy);
            pZMRSegment.set(OPAS_23.ZMR_6_Extension_phone, aExtension);
        }
        return pZMRSegment;
    }
    ...
    //--------------------------------------------------------------------------
    /**
     * OPAS specific processing for ZBX segment
     * @param pHL7Message HL7 message
     * @throws BHLibClasses.ICANException ICANException
     * @return ZBX group
     */
    public HL7Group processOPAS_ZBX(HL7Message pHL7Message) throws ICANException {
        ...
        //System.out.println("++++ ZBX Segments in Msg for OPAS: " + aCountZBXSegments );
        ...
        for (int i = 1; i <= aCountZBXSegments; i++) {
            ...
            //System.out.println("++++ Constructing ZBX WIES SEGMENTS FOR OPAS");
 //Covert WIES Values to OPAS Format
            if( aGroupID.equalsIgnoreCase("VISIT") &&
