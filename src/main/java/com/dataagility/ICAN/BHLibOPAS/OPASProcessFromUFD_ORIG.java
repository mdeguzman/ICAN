 ...
 */
public class OPASProcessFromUFD_ORIG extends ProcessSegmentsFromUFD {
    /**
     * Constant class
     */
     ...
     */
    public OPASProcessFromUFD_ORIG(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
