 ...
 * @author sohn
 */
public class GE_RISProcessFromUFD_Backup20120620 extends ProcessSegmentsFromUFD {
    /**
     ...
     */
    public GE_RISProcessFromUFD_Backup20120620(String pHL7Message, String pEnvironment)  throws ICANException {
        super(pHL7Message);
        mVersion = "a";
