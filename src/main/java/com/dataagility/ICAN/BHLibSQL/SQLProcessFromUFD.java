...
package com.dataagility.ICAN.BHLibSQL;
 ...
 * @author fillinghamr
 */
public class SQLProcessFromUFD extends ProcessSegmentsFromUFD {

    public String mEnvironment = "";
    /**
     * Creates a new instance of SQLProcessFromUFD
     */
    public SQLProcessFromUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
        mVersion = "A";
