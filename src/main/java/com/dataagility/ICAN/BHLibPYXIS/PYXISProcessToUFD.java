...
/**
 * PYXISProcessToUFD contains the methods required to build a UFD message
 * from a PYXIS HL7 message structure
 * @author Norman Soh and Ray Fillingham 2005
 */
public class PYXISProcessToUFD extends ProcessSegmentsToUFD {
    /**
    ...
    //--------------------------------------------------------------------------
    /**
     * Creates a new instance of PYXISProcessToUFD
     * @param pHL7Message HL7 message text string
     * @throws BHLibClasses.ICANException ICANException exception class object
     */
    public PYXISProcessToUFD(String pHL7Message, String pEnvironment) throws ICANException {
        super(pHL7Message);
        mVersion = "B";    // PYXISProcessToUFD Release Version Number
        mHL7Message = pHL7Message;
        mEnvironment = pEnvironment;
    }
    //--------------------------------------------------------------------------
    /**
     * Process the message from PYXIS to UFD structure
     * @throws BHLibClasses.ICANException ICANException exception class object
    ...
    public HL7Segment processP03MSHToUFD(HL7Segment pMSHSegment) {
        pMSHSegment.set(HL7_23.MSH_3_sending_application, "PYXIS");
    ...
    public HL7Group processFinGroups_ToUFD() {
        String aFinGroupID[] = PYXIS_231.Group_FinSet;
        ...
        for (int i = 1; i <= aFinGroupCount; i++) {
            ...
            if (aInZFTSegment.getSegment().length() > 0) {
                ...
                aOutZBXSegment.set(HL7_24.ZBX_4_value, aInZFTSegment.get(PYXIS_231.ZFT_1_Charge_Type));
                ...
                aOutZBXSegment.set(HL7_24.ZBX_4_value, aInZFTSegment.get(PYXIS_231.ZFT_12_Invoice_Number));
                aOutZBXSegment.set(HL7_24.ZBX_5_type, aFT1SetID);
                aOutZBXGroup.append(aOutZBXSegment);
                ...
                aOutZBXSegment.set(HL7_24.ZBX_4_value, aInZFTSegment.get(PYXIS_231.ZFT_14_Invoice_Date));
                aOutZBXSegment.set(HL7_24.ZBX_5_type, aFT1SetID);
                aOutZBXGroup.append(aOutZBXSegment);
            }
        }
    ...
    public HL7Group processZCDZBXs_ToUFD() {
        ...
        if (aInZCDSegment.getSegment().length() > 0) {
            ...
            String aClaimNum = aInZCDSegment.get(PYXIS_231.ZCD_11_Claim_Number);
