/*
 * POWERSCRIBEProcessFromUFD.java
 *
 * Created on 11 October 2005, 15:25
 *
 */

package BHLibPOWERSCRIBE;
 ...
 * @author sohn
 */
public class POWERSCRIBEProcessFromUFD extends ProcessSegmentsFromUFD {
...
//--------------------------------------------------------------------------
    /**
     * Creates a new instance of POWERSCRIBEProcessFromUFD
     */
    public POWERSCRIBEProcessFromUFD(String pHL7Message, String pEnvironment)  throws ICANException {
        super(pHL7Message);
        mVersion = "A";    // POWERSCRIBEProcessFromUFD Release Version Number
...
//--------------------------------------------------------------------------
    public String[] processMessage() throws ICANException {
        ...
        String aPOWERSCRIBEMessageArray[] = {k.NULL, k.NULL, k.NULL};
        ...
        if (mInHL7Message.isEvent("O01")) {
            ...
            if (aSendingApp.startsWith("PARIS") && aDiagServSec.equalsIgnoreCase("AP")) {
        ...
        aPOWERSCRIBEMessageArray[0] = aMSHSegment.getField(HL7_23.MSH_3_sending_application);
        aPOWERSCRIBEMessageArray[1] = aMSHSegment.getField(HL7_23.MSH_4_sending_facility);
        aPOWERSCRIBEMessageArray[2] = aOutMess.getMessage();
        return aPOWERSCRIBEMessageArray;
    }
//--------------------------------------------------------------------------
...
//--------------------------------------------------------------------------
    public HL7Group processO01ReqDets_FromUFD() {
        ...
        for (int i = 1; i <= aRequestDetsCount; i++) {
            ...
            if (mEnvironment.indexOf("TEST") >= 0) {
                aOBR21Filler = aOBR21Filler.substring(2, 4) + "Z" + aOBR21Filler.substring(5, 12);
            } else {
                try {
                    aOBR21Filler = aOBR21Filler.substring(2,12);
                } catch (Exception e) {
                    //do nothing - keep OBR21filler intact
                }
            }
