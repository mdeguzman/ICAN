...
/**
 * These are the HL7 field location mappings for PARIS Z segments
 * For PARIS, all mappings for standard HL7 segments(and HL7 sub field mappings i.e CE, CX, XPN ....)
 * are held in the HL7_23 (or HL7_24) class files.
 */

public class PARIS_23 {

    public static String ZB2_1_medicare_number  ="ZB2_1";
    public static String ZB2_2_DVA_number  ="ZB2_2";
    public static String ZB2_3_HIC_provider_number  ="ZB2_3";
    public static String ZB2_4_TAC_claim_number  ="ZB2_4";
    public static String ZB2_5_assing_number  ="ZB2_5";
    public static String ZB2_6_pension_number  ="ZB2_6";
    public static String ZB2_7_home_phone_number  ="ZB2_7";
    public static String ZB2_8_msg_type  ="ZB2_8";
    public static String ZB2_9_packet_print_location  ="ZB2_9";
    public static String ZB2_10_spare  ="ZB2_10";
...
//public static String ZEI_15_Contact_Title  ="ZEI_16";
    ...
    /** Creates a new instance of PARIS_23 */
    public PARIS_23() {
    }
