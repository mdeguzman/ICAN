...
/**
 * <p> These are the HL7 field location mappings for HL7 2.3 Standard Segments and Fields
 * For vendor specific Z segments (i.e Cerner, CSC, STOCCA) the mappings
 * are held in the the vendor specific classes e.g CSC_23, CERNER_23 - files.
 * <p><p>
...
//
    /** CP Data type - used for Transaction Amounts in Finance */
    public static String CP_1_price = "CP_1";
    public static String CP_2_price_type = "CP_2";
    public static String CP_3_from_value = "CP_3";
    public static String CP_4_to_value = "CP_4";
    public static String CP_5_range_units = "CP_5";
    public static String CP_6_range_type = "CP_6";
//
...
// Definition of Segment structures --------------------------------------------
    ...
    public static String ACC_1_accident_date_time  = "ACC_1";
    public static String ACC_2_accident_code  = "ACC_2";
    public static String ACC_3_accident_location  = "ACC_3";
...
//
    ...
    public static String Group_Orders_without_ORC[] = {"OBR","NTE","OBX"};
